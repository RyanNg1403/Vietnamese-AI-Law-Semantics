...
# --- CẤU HÌNH ---
INPUT_CSV = '/Users/PhatNguyen/Desktop/vietnamese-legal-text/data/gold_standard_completed.csv'  # Tên file bạn đã sửa
OUTPUT_PL = '/Users/PhatNguyen/Desktop/vietnamese-legal-text/data/knowledge_base.pl'            # Tên file Prolog đầu ra
